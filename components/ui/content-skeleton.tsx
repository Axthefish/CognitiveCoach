...
export function ContentSkeleton({ stage, onRetry }: ContentSkeletonProps) {
              ...
              <div className="space-y-3">
                {[...Array(3)].map((_, i) => (
                  <div key={i} className="space-y-2">
                    <div className="h-5 bg-gray-200 dark:bg-gray-600 rounded w-1/3 animate-pulse" />
        ...
        return (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="h-6 bg-gray-200 dark:bg-gray-600 rounded w-1/3 animate-pulse mb-4" />
              <div className="aspect-[4/3] bg-gray-100 dark:bg-gray-800 rounded-lg animate-pulse flex items-center justify-center">
                <div className="text-gray-400 dark:text-gray-600 text-center">
                  <div className="w-16 h-16 bg-gray-200 dark:bg-gray-600 rounded-full mb-4 mx-auto animate-pulse" />
                  <div className="h-4 bg-gray-200 dark:bg-gray-600 rounded w-32 mx-auto animate-pulse" />
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="h-6 bg-gray-200 dark:bg-gray-600 rounded w-2/3 animate-pulse mb-4" />
              <div className="space-y-3">
                {[...Array(4)].map((_, i) => (
      ...
      case 'S3':
        return (
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="flex items-center space-x-3 p-3 border rounded-lg">
                    <div className="w-5 h-5 bg-gray-200 dark:bg-gray-600 rounded animate-pulse" />
            ...
            {/* KPIs 占位 */}
            <div>
              <div className="h-6 bg-gray-200 dark:bg-gray-600 rounded w-1/4 animate-pulse mb-4" />
  ...
  return (
    <div className="w-full p-6 space-y-6 animate-fade-in">
      ...
      <div className="bg-white dark:bg-gray-800/50 border rounded-lg p-6">
